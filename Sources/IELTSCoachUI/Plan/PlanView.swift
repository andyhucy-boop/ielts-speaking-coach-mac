...
struct PlanView: View {
    ...
    static let focusScopeNote = "这一项只决定这份计划每天排哪些题。"
        ...
        + "在那儿改不会动这份计划。"
        // 「连着练」这一档在那张窗口上不是第五格按钮，而是 Part 2 底下的一颗开关
        //（理由见 `PracticePicker.showsLinkPart3`）。不说清的话，用户在这儿选了它，
        // 到那边看到档位停在「Part 2」，会以为这个选择根本没生效。
        + "选了 Part 2 + Part 3 连着练时，那排按钮会停在 Part 2，"
        + "下面那颗「练完 Part 2 接着练 Part 3」开关也会默认打开。"
