...
public enum Changelog {
    ...
    public static let releases: [ReleaseNote] = [
        ReleaseNote(
            version: "1.3.0",
            date: "2026-08-30",
            headline: "界面改版：读得清、点得着、认得出；另外会自己告诉你有没有新版本。",
            changes: [
                "整个界面重新排过：正文限宽（以前窗口拉宽就是一行上百个字）、"
                    + "字号分档（以前卡片标题和正文同号）、中文段落加了行距",
                "侧边栏换成设计稿里那条深色的，按「练习 / 复盘 / 资料与设置」分组",
                "卡片整块可点了——以前只有角落那颗小按钮管用，点卡片本身没反应",
                "鼠标划过卡片、列表行、侧边栏都有反应了（以前全项目一处悬停都没有）",
                "选中的侧边栏项、面板上的按钮用上了 macOS 26 的液态玻璃",
                "首页四格不再上下错开；复盘页「带着这条去复训」以前在深色面板上看不见",
                "「功能升级」页会自己去 GitHub 看有没有新版本（每天最多问一次）；"
                    + "它只告诉你、并把发布页打开，不会自己下载或替换 App",
                "「功能升级」和「问题反馈」两页现在也能用 ieltscoach:// 链接直接打开了"
            ]),
        ReleaseNote(
            version: "1.2.0",
            date: "2026-08-20",
